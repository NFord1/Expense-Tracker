...
// Importing necessary components and utilities from Material-UI and other libraries
...
// Creating a theme for Material-UI components
...
const LogExpense = ({ handleClose, _id, refreshExpenses }) => {
  ...
  // Function to refresh expense list and handle errors
